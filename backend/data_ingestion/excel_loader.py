# backend/data_ingestion/excel_loader.py (Ensure this file has drop_table at the end)
...
import os
import tempfile
# To avoid circular import issues, import helpers here but make sanitize_dataframe_columns minimal
